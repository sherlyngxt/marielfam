...
//CREATE PAPER LAYERS
        ...
        var popup = document.getElementById("paper2");
        var black = document.getElementById("paper3");
        var header = document.getElementById("paper4"); 
        var closesign = document.getElementById("paper5");
        var ethno = document.getElementById("paper6");
        var skipbutton = document.getElementById("paper7");
    ...
    button1.node.addEventListener('click', function(ev){ 
        ...
        ethno.style.zIndex = "1";   
            ...
            button3.node.addEventListener('click', function(ev){   
                ...
                var tie = paper5.image("css/resources/exit.png", 0, 0, 55, 55);
                tie.node.addEventListener('mousemove', function(ev){
                    tie.node.style.cursor = "pointer";
                });            
                tie.node.addEventListener('click', function(ev){
            ...
            button2.node.addEventListener('click', function(ev){   
                ...
                var script1 = paper6.image("css/resources/ethn0.png", 242.5, 50, 515, 700);
                var script2 = paper6.image("css/resources/ethn1.png", 242.5, 50, 515, 700);
                var script3 = paper6.image("css/resources/ethn2.png", 242.5, 50, 515, 700);
                var script4 = paper6.image("css/resources/gen1.png", 100, 106, 800, 588);
                var script5 = paper6.image("css/resources/gen2.png", 242.5, 50, 515, 700);
                var script6 = paper6.image("css/resources/gen3.png", 242.5, 50, 515, 700);
                var script7 = paper6.image("css/resources/gen4.png", 242.5, 50, 515, 700);

                var right = paper6.image("css/resources/right.png", 778, 350, 63, 49);
                
                var right2 = paper6.image("css/resources/right.png", 778, 350, 63, 49);
                var left2 = paper6.image("css/resources/left.png", 130, 350, 72, 44);

                var right3 = paper6.image("css/resources/right.png", 778, 350, 63, 49);
                var left3 = paper6.image("css/resources/left.png", 130, 350, 72, 44);

                var right4 = paper6.image("css/resources/right.png", 900, 350, 63, 49);
                var left4 = paper6.image("css/resources/left.png", 15, 350, 72, 44);

                var right5 = paper6.image("css/resources/right.png", 778, 350, 63, 49);
                var left5 = paper6.image("css/resources/left.png", 130, 350, 72, 44);

                var right6 = paper6.image("css/resources/right.png", 778, 350, 63, 49);
                var left6 = paper6.image("css/resources/left.png", 130, 350, 72, 44);

                var left7 = paper6.image("css/resources/left.png", 130, 350, 72, 44);
        ...
        pic1.node.addEventListener('click', function(ev){ 
            ...
            setTimeout(function(){
                ...
                var buttonphoto = paper2.image("css/resources/buttonphoto.png", 910, 90, 50, 50);
                //var buttonvideo = paper6.image("css/resources/button3.png", 910, 150, 50, 50);
                var buttonscript = paper2.image("css/resources/button2.png", 910, 150, 50, 50);
                ...
                var theresa1 = paper2.image("css/resources/theresa1.png", 100, 0, 800, 600); 
                    var next = paper2.rect(280,440,430,30);
                    next.attr({
                        "fill": "white",
                        "opacity": "0"
                    });
                ...
                var theresa2 = paper2.image("css/resources/theresa2.png", 100, 0, 800, 600);
                    var next2 = paper2.rect(280,440,430,30);
                    next2.attr({
                        "fill": "white",
                        "opacity": "0"
                    });

                var theresa3 = paper2.image("css/resources/theresa3.png", 100, 0, 800, 600);
                    var next3 = paper2.rect(280,440,430,30);
                    next3.attr({
                        "fill": "white",
                        "opacity": "0"
                    });    

                var theresa4 = paper2.image("css/resources/theresa4.png", 100, 0, 800, 600);
                    var next4 = paper2.rect(280,440,430,30);
                    next4.attr({
                        "fill": "white",
                        "opacity": "0"
                    });

                var photo1 = paper2.image("css/resources/lauma1.png", 288.5, 0, 423, 600);
                var photo2 = paper2.image("css/resources/lauma2.png", 100, 27.5, 800, 545);
                var photo3 = paper2.image("css/resources/lauma3.png", 100, 35, 800, 530);
                var photo4 = paper2.image("css/resources/lauma4.png", 100, 25.5, 800, 549);
                var photo5 = paper2.image("css/resources/lauma5.png", 100, 25.5, 800, 549);

                var script1 = paper2.image("css/resources/script0.png", 267.5, 0, 465, 600);
                var script2 = paper2.image("css/resources/script1.png", 267.5, 0, 465, 600);
                var script3 = paper2.image("css/resources/script2.png", 267.5, 0, 465, 600);
                var script4 = paper2.image("css/resources/script3.png", 267.5, 0, 465, 600);
                var script5 = paper2.image("css/resources/script4.png", 267.5, 0, 465, 600);
                
                var right = paper2.image("css/resources/right.png", 740, 275, 63, 49);
                
                var right2 = paper2.image("css/resources/right.png", 740, 275, 63, 49);
                var left2 = paper2.image("css/resources/left.png", 194, 275, 72, 44);

                var right3 = paper2.image("css/resources/right.png", 740, 275, 63, 49);
                var left3 = paper2.image("css/resources/left.png", 194, 275, 72, 44);

                var right4 = paper2.image("css/resources/right.png", 740, 275, 63, 49);
                var left4 = paper2.image("css/resources/left.png", 194, 275, 72, 44);

                var left5 = paper2.image("css/resources/left.png", 194, 275, 72, 44);

                var rightp = paper2.image("css/resources/right.png", 730, 275, 63, 49);
                
                var right2p = paper2.image("css/resources/right.png", 905, 275, 63, 49);
                var left2p = paper2.image("css/resources/left.png", 30, 275, 72, 44);

                var right3p = paper2.image("css/resources/right.png", 905, 275, 63, 49);
                var left3p = paper2.image("css/resources/left.png", 30, 275, 72, 44);

                var right4p = paper2.image("css/resources/right.png", 905, 275, 63, 49);
                var left4p = paper2.image("css/resources/left.png", 30, 275, 72, 44);

                var left5p = paper2.image("css/resources/left.png", 30, 275, 72, 44);
        ...
        pic3.node.addEventListener('click', function(ev){ 
            ...
            popup.style.zIndex = "1";   
                ...
                var buttonscript = paper2.image("css/resources/button2.png", 910, 60, 55, 55);
                var buttonphoto = paper2.image("css/resources/buttonphoto.png", 910, 120, 50, 50);
                ...
                var photo1 = paper2.image("css/resources/anthonyphotos.png", 100, 46.5, 800, 507);
                var photo2 = paper2.image("css/resources/anthonyphoto2.png", 100, 46, 800, 508);
               
                var rightp = paper2.image("css/resources/right.png", 900, 275, 63, 49);
                var left2p = paper2.image("css/resources/left.png", 29, 275, 72, 44);

                var script1 = paper2.image("css/resources/letter1.png", 100, 55, 800, 490);
                var script2 = paper2.image("css/resources/letter2.png", 288.5, 0, 423, 600);
                var script3 = paper2.image("css/resources/letter3.png", 288.5, 0, 423, 600);
                var script4 = paper2.image("css/resources/letter4.png", 100, 58, 800, 484);
                var script5 = paper2.image("css/resources/letter5.png", 294.5, 0, 411, 600);
                var script6 = paper2.image("css/resources/letter6.png", 100, 48, 800, 506);
                
                var right = paper2.image("css/resources/right.png", 900, 275, 63, 49);
                
                var right2 = paper2.image("css/resources/right.png", 715, 275, 63, 49);
                var left2 = paper2.image("css/resources/left.png", 231, 275, 72, 44);

                var right3 = paper2.image("css/resources/right.png", 715, 275, 63, 49);
                var left3 = paper2.image("css/resources/left.png", 231, 275, 72, 44);

                var right4 = paper2.image("css/resources/right.png", 890, 275, 63, 49);
                var left4 = paper2.image("css/resources/left.png", 29, 275, 72, 44);

                var left5 = paper2.image("css/resources/left.png", 245, 275, 72, 44);
                var right5 = paper2.image("css/resources/right.png", 720, 275, 63, 49);

                var left6 = paper2.image("css/resources/left.png", 20, 275, 72, 44);
